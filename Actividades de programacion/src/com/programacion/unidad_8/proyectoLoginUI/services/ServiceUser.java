package com.programacion.unidad_8.proyectoLoginUI.services;
...
import com.programacion.Unidad_7.proyectoUbriCine.services.impl.LoggerService;
...
public class ServiceUser implements BasicServiceUser{
    ...
    public boolean loginUI(String usuario, String passUser){
        return users.stream()
                .filter(user -> user.getName().equalsIgnoreCase(usuario) && user.getPass().equals(passUser))
                .findFirst()
                .isPresent();
    }
